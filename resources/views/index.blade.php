    ...
    @foreach ($productsByCategory as $categoryId => $categoryProducts)
        ...
        <section class="my-4">
            ...
            <div id="carousel{{ $categoryId }}" class="carousel carousel-dark slide" data-bs-ride="carousel">
                                ...
                                @foreach ($chunk as $product)
                                    <div class="col-md-3">
                                        <div class="card mb-4 ms-3 smaller-card">
                                            <a href="{{ route('products.show', ['product' => $product->id]) }}" style="text-decoration: none; color: #333;">
                ...
                <button class="carousel-control-prev" type="button" data-bs-target="#carousel{{ $categoryId }}"data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Anterior</span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#carousel{{ $categoryId }}" data-bs-slide="next">
...
<style>
    ...
    .carousel-control-next-icon {
        width: 3rem; /* Ajustar el tamaño según sea necesario */
        height: 3rem; /* Ajustar el tamaño según sea necesario */
    }
</style>
